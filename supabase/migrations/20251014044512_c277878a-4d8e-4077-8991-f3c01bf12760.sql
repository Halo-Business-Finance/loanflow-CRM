-- Update assign_user_role function to remove MFA verification requirement
-- MFA is for user login security, not for admin role management operations
...
-- Update revoke_user_role function to remove MFA verification requirement
...
BEGIN
  ...
  -- Set role to 'viewer' (lowest level)
  UPDATE public.user_roles 
