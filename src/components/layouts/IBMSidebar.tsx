...
function NavItem({ icon: Icon, label, to, collapsed, subItems }: NavItemProps) {
    ...
    return (
      <div>
        <div
          onClick={handleClick}
          className={cn(
            'flex items-center h-10 text-xs transition-colors relative group cursor-pointer',
          ...
          <div className="ml-4 border-l border-[#e0e0e0]">
            {subItems.map((subItem) => (
              <NavLink
                ...
                to={subItem.to!}
                className={cn(
                  'flex items-center h-7 text-xs transition-colors relative pl-4',
  ...
  return (
    <NavLink
      to={to!}
      className={cn(
        'flex items-center h-10 text-xs transition-colors relative group',
        collapsed ? 'justify-center w-12 px-0' : 'pl-0 pr-4',
        isActive
          ? 'bg-[#e0e0e0] text-[#161616] font-medium'
          : 'text-[#525252] hover:bg-[#e0e0e0] hover:text-[#161616]'
