    ...
    <header className="h-24 bg-[#161616] border-b border-[#393939] flex items-center justify-between flex-shrink-0 w-full px-4">
      ...
      <div className="flex items-center h-full flex-1" style={{ minWidth: sidebarCollapsed ? '48px' : '240px' }}>
        <Button
          ...
          size="icon"
          onClick={onMenuClick}
          className="h-24 w-12 rounded-none text-white flex-shrink-0 flex items-center justify-center p-0"
        >
        ...
        <div className="flex items-center gap-0">
          <Button
            ...
            className="h-24 w-10 rounded-none text-white flex-shrink-0"
            title="Go back"
          >
